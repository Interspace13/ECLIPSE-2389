...
/datum/gear/shoes/tajara/boots/New()
	...
	boots["high-heeled adhomian shoes, red"] = /obj/item/clothing/shoes/heels/tajara/red
	boots["oxfords, black"] = /obj/item/clothing/shoes/laceup/tajara
	boots["oxfords, brown"] = /obj/item/clothing/shoes/laceup/brown/tajara
	boots["dress flats, black"] = /obj/item/clothing/shoes/flats/tajara
	boots["dress flats, dark"] = /obj/item/clothing/shoes/flats/tajara/dark
	boots["dress flats, white"] = /obj/item/clothing/shoes/flats/tajara/white
	boots["dress flats, red"] = /obj/item/clothing/shoes/flats/tajara/red
	boots["dress flats, scarlet"] = /obj/item/clothing/shoes/flats/tajara/scarlet
	boots["dress flats, mauve"] = /obj/item/clothing/shoes/flats/tajara/mauve
	boots["dress flats, blue"] = /obj/item/clothing/shoes/flats/tajara/blue
	boots["dress flats, green"] = /obj/item/clothing/shoes/flats/tajara/green
	boots["dress flats, purple"] = /obj/item/clothing/shoes/flats/tajara/purple
...
/datum/gear/uniform/tajara
	display_name = "tajaran uniform and dress selection"
	description = "A selection of tajaran native uniforms and dresses."
...
/datum/gear/uniform/tajara/New()
	...
	uniform["white fancy adhomian dress"] = /obj/item/clothing/under/dress/tajaran
	uniform["blue fancy adhomian dress"] = /obj/item/clothing/under/dress/tajaran/blue
	uniform["green fancy adhomian dress"] = /obj/item/clothing/under/dress/tajaran/green
	uniform["red fancy adhomian dress"] = /obj/item/clothing/under/dress/tajaran/red
	...
	uniform["polka dot dress, red"] = /obj/item/clothing/under/dress/tajaran/polka_dot
	uniform["polka dot dress, black"] = /obj/item/clothing/under/dress/tajaran/polka_dot/black
	uniform["floral dress"] = /obj/item/clothing/under/dress/tajaran/floral
	uniform["housewife dress, plaid"] = /obj/item/clothing/under/dress/tajaran/housewife
...
/datum/gear/suit/tajara_coat/New()
	...
	coat["PRA submariner coat"] = /obj/item/clothing/suit/storage/tajaran/pra_submarine
...
/datum/gear/accessory/tajaran_gen_accessorry/New()
	..()
	var/list/card = list()
	card["pra zbrojny badge"] = /obj/item/clothing/accessory/tajaran/zbrojny_badge
	card["dpra tank corps golden sun pin"] = /obj/item/clothing/accessory/tajaran/tanker_pin
...
/datum/gear/accessory/nka_colorable_accessory
	display_name = "new kingdom noble accessories clothes (colorable)"
...
/datum/gear/accessory/tajara_wrap
	display_name = "marriage items"
	description = "Items from the S'rand'marr and Ma'ta'ke signifying marriage between two people."
...
/datum/gear/accessory/tajara_wrap/New()
	..()
	var/list/wrap = list()
	wrap["S'rand'marr marriage wrap, male"] = /obj/item/clothing/accessory/tajaran_wrap
	wrap["S'rand'marr marriage wrap, female"] = /obj/item/clothing/accessory/tajaran_wrap/female
	wrap["Ma'ta'ke ceremonial pelt"] = /obj/item/clothing/accessory/tajaran_pelt
