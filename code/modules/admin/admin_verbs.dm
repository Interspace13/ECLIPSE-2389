...
GLOBAL_LIST_INIT(admin_verbs_server, list(
	/datum/controller/subsystem/processing/HiveEchoes/proc/ToggleEchoes, //Toggles if Vaurcae receieve faint echoes (fluff) of the wider Hivenet. Useful for events or gimmicks.
