/datum/map/shinohara
	...
	station_name = "ISX Shinohara"
	station_short = "Shinohara"
	...
	command_spawn_message = "Welcome to the ISX Shinohara!"
...
/datum/map/shinohara/send_welcome()
	var/obj/effect/overmap/visitable/ship/horizon = SSshuttle.ship_by_type(overmap_visitable_type)

	var/welcome_text = "<center><img src = scclogo.png><br />[FONT_LARGE("<b>ISX Shinohara</b> Ultra-Range Sensor Readings:")]<br>"
	...
	post_comm_message("ISX Shinohara Sensor Report", welcome_text)
...
/datum/map/shinohara/load_holodeck_programs()
